...
tokenizer = BertTokenizer.from_pretrained('../BERT/pretrained_bert_tf/biobert_pretrain_output_all_notes_150000')
...
save_dir = './exp/'+model_name+'_'+date[1:-1]+'_{}/'.format(hpara1.max_sent_len)
